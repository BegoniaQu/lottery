                    ...
                    <div class="widget-body" style="padding-bottom: 0px;">
                        <form id="addForm" method="post">
                                ...
                                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        ...
                                        <div class="databox-right ">
                                            <input id="termNum" name="termNum" class="input-sm form-control validate[custom[integer]] validate[required]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        ...
                                        <div class=" databox-right ">
                                         <div class="input-group">
                                            <input class="input-sm form-control date-picker validate[required]" id="nextDate" name="nextDate" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12" >
                                    <div class="databox" style="margin-bottom: 0px;padding-left:0px;height: 50px;">
                                        ...
                                        <div class=" databox-right ">
                                          <div class="input-group">
                                             <input class="input-sm form-control validate[required]"  id="timepicker1" name="nextTime">
                                             <span class="input-group-addon">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum1" name="awardNum1"></div>
                                    </div>
                                </div>
                                <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum2" name="awardNum2"></div>
                                    </div>
                                </div>
                                <div class="col-xs-1">
                                     <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum3" name="awardNum3"></div>
                                     </div>
                                </div>
                                <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                       <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum4" name="awardNum4"></div>
                                    </div>
                                </div>
                                 <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                       <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum5" name="awardNum5"></div>
                                    </div>
                                </div>
                                 <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                       <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum6" name="awardNum6"></div>
                                    </div>
                                </div>
                                 <div class="col-xs-1">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                       <div class="databox-right"><input class="input-sm form-control validate[max[49]] validate[min[1]] validate[required]" id="awardNum7" name="awardNum7"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="databox-left"
                                        ...
                                        <input type="button" id="sendButton" class="btn btn-success" value="提交" style="margin-right: 5px;" onclick="addAwardSubmit()"/>
                                    </div>
                                </div>
                            </div>
                        </form>
