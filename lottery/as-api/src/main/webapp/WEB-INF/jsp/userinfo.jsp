                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        ...
                                        <div class=" databox-right ">
                                            <input name="phoneNum"
                                                   class="input-sm form-control validate[custom[phone]] validate[required]"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        ...
                                        <div class=" databox-right ">
                                            <select name="type" id="type"
                                                    class="select-sm form-control validate[required]"
                                                    style="height: 30px;">
                                ...
                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="databox-left"
                                        ...
                                        <input type="button" id="sendButton" class="btn btn-success" value="提交"
                                               style="margin-right: 5px;" onclick="addUserSubmit()"/>
                                    </div>
                                </div>
                            </div>
                        </form>
