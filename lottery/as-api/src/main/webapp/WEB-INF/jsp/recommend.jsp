                                        ...
                                        <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                           ...
                                           <div class="databox-right">
                                               <div class="input-group">
                                                    <input class="input-sm form-control date-picker validate[required]" id="time" name="time" data-date-format="yyyy-mm-dd">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                            <div class="databox-left no-padding-right no-padding-left"
                                             ...
                                             <div class="databox-right">
                                                <input class="input-sm form-control validate[custom[integer]] validate[required]" id="num" name="num">
                                           </div>
                                        </div>
                                    </div>
                                </div>
					            <div class="row">
                                    <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                                        <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                            ...
                                            <div class="databox-right ">
                                                <textarea class="form-control validate[required]" rows="3" name="content" placeholder="多个请逗号分隔,‘中’请括号包含，如：正五:單(中),正二:合雙"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12"
                                        ...
                                        <div class="databox-left"
                                            ...
                                            <input type="button" id="sendButton" class="btn btn-success" value="提交" style="margin-right: 5px;" onclick="addRecommendSubmit()"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                    <div class="databox" style="margin-bottom: 0px; height: 50px;">
                                        ...
                                        <div class="databox-right ">
                                            <input name="periodNum" id="periodNum" class="input-sm form-control"  placeholder="例如：40"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
        	...
        	$("#table").bootstrapTable({
            	...
            	function query(){
                		$("#table").bootstrapTable('refresh',{
                			query:{periodNum:escape($('#periodNum').val()),
                			       year:escape($('#yer').val())}
                		});
                }
