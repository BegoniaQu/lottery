 ...
 */
@ApiModel(description = "历史开奖数据详情")
public class HisAwardDetailRespBean {
    ...
    private List<HistoryDetailBall> balls; //球

    @ApiModelProperty(value = "特码分析")
    private HisTDetail hisTDetail;
    ...
    public class HistoryDetailBall {
    ...
    public List<HistoryDetailBall> getBalls() {
        return balls;
    }

    public void setBalls(List<HistoryDetailBall> balls) {
        this.balls = balls;
    }

    public HisTDetail getHisTDetail() {
        return hisTDetail;
    }

    public void setHisTDetail(HisTDetail hisTDetail) {
